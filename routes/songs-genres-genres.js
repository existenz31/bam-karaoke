...
const { songsGenresGenres } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('songsGenresGenres');

// This file contains the logic of every route in Forest Admin for the collection songsGenresGenres:
...
// Create a Songs Genres Genre
router.post('/songsGenresGenres', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Songs Genres Genre
router.put('/songsGenresGenres/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Songs Genres Genre
router.delete('/songsGenresGenres/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Songs Genres Genres
router.get('/songsGenresGenres', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Songs Genres Genres
router.get('/songsGenresGenres/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Songs Genres Genre
router.get('/songsGenresGenres/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Songs Genres Genres
router.get('/songsGenresGenres.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
