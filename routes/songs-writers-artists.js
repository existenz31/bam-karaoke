...
const { songsWritersArtists } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('songsWritersArtists');

// This file contains the logic of every route in Forest Admin for the collection songsWritersArtists:
...
// Create a Songs Writers Artist
router.post('/songsWritersArtists', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Songs Writers Artist
router.put('/songsWritersArtists/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Songs Writers Artist
router.delete('/songsWritersArtists/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Songs Writers Artists
router.get('/songsWritersArtists', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Songs Writers Artists
router.get('/songsWritersArtists/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Songs Writers Artist
router.get('/songsWritersArtists/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Songs Writers Artists
router.get('/songsWritersArtists.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
