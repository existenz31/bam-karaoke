...
const { playlistsSongsSongs } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('playlistsSongsSongs');

// This file contains the logic of every route in Forest Admin for the collection playlistsSongsSongs:
...
// Create a Playlists Songs Song
router.post('/playlistsSongsSongs', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Playlists Songs Song
router.put('/playlistsSongsSongs/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Playlists Songs Song
router.delete('/playlistsSongsSongs/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Playlists Songs Songs
router.get('/playlistsSongsSongs', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Playlists Songs Songs
router.get('/playlistsSongsSongs/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Playlists Songs Song
router.get('/playlistsSongsSongs/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Playlists Songs Songs
router.get('/playlistsSongsSongs.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
