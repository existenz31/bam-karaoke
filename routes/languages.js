...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('languages');

// This file contains the logic of every route in Forest Admin for the collection languages:
...
// Create a Language
router.post('/languages', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Language
router.put('/languages/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Language
router.delete('/languages/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/languages', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/languages/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Language
router.get('/languages/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/languages.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
