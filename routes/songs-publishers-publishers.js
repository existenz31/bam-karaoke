...
const { songsPublishersPublishers } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('songsPublishersPublishers');

// This file contains the logic of every route in Forest Admin for the collection songsPublishersPublishers:
...
// Create a Songs Publishers Publisher
router.post('/songsPublishersPublishers', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Songs Publishers Publisher
router.put('/songsPublishersPublishers/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Songs Publishers Publisher
router.delete('/songsPublishersPublishers/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Songs Publishers Publishers
router.get('/songsPublishersPublishers', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Songs Publishers Publishers
router.get('/songsPublishersPublishers/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Songs Publishers Publisher
router.get('/songsPublishersPublishers/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Songs Publishers Publishers
router.get('/songsPublishersPublishers.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
